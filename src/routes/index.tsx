...
const programs = [
  { title: "المرحلة الابتدائية", grades: "من KG1 إلى الصف السادس", desc: "أساس قوي في القراءة والكتابة والرياضيات مع أنشطة إبداعية" },
  { title: "المرحلة الإعدادية", grades: "من الصف السابع إلى التاسع", desc: "تعميق المفاهيم العلمية وتنمية مهارات البحث والتحليل" },
  { title: "المرحلة الثانوية", grades: "من الصف العاشر إلى الثاني عشر", desc: "إعداد شامل للجامعة مع مسارات علمية وأدبية متنوعة" },
];
...
const news = [
  ...
  { date: "١٥ مايو ٢٠٢٥", title: "ورشة عمل لأولياء الأمور حول التعلم الرقمي", tag: "فعاليات" },
      ...
      <section id="about" className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-[1fr_1.1fr] md:items-start">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
              تأسست المدرسة عام ٢٠٠٠ برؤية واضحة: تقديم تعليم عالي الجودة يواكب متطلبات العصر
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            { icon: Heart, title: "رعاية شاملة", desc: "مرشد طلابي ودعم نفسي لضمان رفاهية كل طالب" },
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div>
              ...
              <p className="mt-4 text-sm text-white/70">
                مؤسسة تعليمية رائدة في ٦ أكتوبر منذ عام ٢٠٠٠
              </p>
            </div>
            <div>
